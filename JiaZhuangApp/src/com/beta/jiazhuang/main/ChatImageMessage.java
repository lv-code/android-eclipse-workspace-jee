...
private ImageView mIvImage;
	...
	protected synchronized void  onFillMessage() {
		...
		SoftReference<Bitmap> softReference = MyBaseApplication.getInstance().mPhotoOriginalCache.get(mMsg.getContent());
	...
	public void putBitmap(){
		...
		MyBaseApplication.getInstance().mPhotoOriginalCache.put(mMsg.getContent(), new SoftReference<Bitmap>(mBitmap));
